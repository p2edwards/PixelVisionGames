...
function DrawEntity(entity, offsetX, offsetY)
  ...
  if(entity.spriteData ~= nil) then
    DrawSprites(entity.spriteData.spriteIDs, entity.x + offsetX, entity.y + offsetY, entity.spriteData.width, entity.flipH, entity.flipV, entity.drawMode, entity.offset, false, false)
  end
end
