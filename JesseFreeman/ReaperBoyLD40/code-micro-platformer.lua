...
function MicroPlatformer:Draw()
	...
	if(self.player.spriteData ~= nil) then

		--draw the player, represented as sprite 1.
		DrawSprite(self.player.spriteData.spriteIDs[self.player.spriteID], self.player.x, self.player.y, self.player.dir, false, DrawMode.Sprite)--draw player
	end
end
